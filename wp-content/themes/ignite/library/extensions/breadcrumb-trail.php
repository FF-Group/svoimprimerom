...
class Breadcrumb_Trail {
	...
	public function default_labels() {
		...
		$labels = array(
			'browse'              => __( 'Сайт:',                 'breadcrumb-trail' ),
			'home'                => __( 'Главная',                    'breadcrumb-trail' ),
			'search'              => __( 'Результаты поиска: "%s"', 'breadcrumb-trail' ),
			'error_404'           => __( 'Ошибка 404',           'breadcrumb-trail' ),
			'paged'               => __( 'Страница %d',                 'breadcrumb-trail' ),
			'archives'            => __( 'Архив',                'breadcrumb-trail' ),
			'archive_minute_hour' => __( 'g:i a',                   'breadcrumb-trail' ),
			'archive_minute'      => __( 'Минут %d',               'breadcrumb-trail' ),
			'archive_hour'        => __( 'g a',                     'breadcrumb-trail' ),
			'archive_day'         => __( 'd',                       'breadcrumb-trail' ),
			'archive_week'        => __( 'Неделя %d',                 'breadcrumb-trail' ),
